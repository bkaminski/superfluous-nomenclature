	<div class="container pt-5 home-about">
		...
		<br />
		<p class="text-center pb-3"><!-- <a href="<?php //echo get_home_url(); ?>/beers/" class="btn btn-lg btn-success text-uppercase p-3 rounded-0"><i class="fas fa-beer fa-fw mr-2"></i>Check out our beers!</a> --></p>
	</div>
