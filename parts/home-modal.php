      ...
      <div class="modal-footer text-center">
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-12">
              <a href="https://google.com" type="button" class="btn btn-secondary btn-lg btn-block rounded-0">I am under 21 or decline</a>
            </div>
          </div>
        </div>
      </div>
