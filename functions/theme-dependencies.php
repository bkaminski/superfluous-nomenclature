...
function enqueue_wbwbeer_scripts() {
    ...
    wp_enqueue_script('wbw-scripts', get_template_directory_uri() . '/assets/js/wbwScripts.min.js', array('jquery'), null, true, null);
    wp_enqueue_script('google-fonts', 'https://fonts.googleapis.com/css?family=Montserrat|Roboto&display=swap', array(), '1.0' );
}
