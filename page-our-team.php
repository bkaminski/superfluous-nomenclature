...
<div class="container">
	<div class="main-content-area">
		...
		<div class="card-deck mt-3 mb-3">
			<div class="card">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Bio-Craig2.png" class="card-img-top p-3 about--img rounded" alt="Craig Wensell" style="background:#1d547e;">
				<div class="card-body">
			...
			<div class="card">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/img/keith-bio.png" class="card-img-top p-3 about--img rounded" alt="B. Keith Hughes" style="background:#1d547e;">
				<div class="card-body">
			...
			<div class="card">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Bio-John2.png" class="card-img-top p-3 about--img rounded" alt="John Fusco" style="background:#1d547e;">
				<div class="card-body">
		...
		<div class="card-deck">
			<div class="card">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Bio-Dan2.png" class="card-img-top p-3 about--img2 rounded" alt="Dan Yopp" style="background:#1d547e;">
				<div class="card-body">
			...
			<div class="card">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Bio-derek2.png" class="card-img-top p-3 about--img2 rounded" alt="Derek Berkeley" style="background:#1d547e;">
				<div class="card-body">
		...
		<div class="card-deck mt-3 pb-3">
			<div class="card">
				<img src="" class="card-img-top p-3 about--img rounded" alt="Jennifer Hughes" style="background:#1d547e;">
				<div class="card-body">
			...
			<div class="card">
				<img src="" class="card-img-top p-3 about--img rounded" alt="Ryan Rice" style="background:#1d547e;">
				<div class="card-body">
			...
			<div class="card">
				<img src="" class="card-img-top p-3 about--img rounded" alt="Ben Kaminski" style="background:#1d547e;">
				<div class="card-body">
					<h5 class="card-title text-center font-weight-bold">Ben Kaminski<br /> Web Development</h5>
					<p class="card-text small"></p>
				</div>
			</div>
		</div>
		<div class="card-deck mt-3 pb-3">
			<div class="card">
				<img src="" class="card-img-top p-3 about--img rounded" alt="Jeff Kempista" style="background:#1d547e;">
				<div class="card-body">
					<h5 class="card-title text-center font-weight-bold">Jeff Kempista<br />Application Development</h5>
					<p class="card-text small"></p>
				</div>
			</div>
			<div class="card">
				<img src="" class="card-img-top p-3 about--img rounded" alt="Lisa Fusco" style="background:#1d547e;">
				<div class="card-body">
			...
			<div class="card">
				<img src="" class="card-img-top p-3 about--img rounded" alt="Laura McDonald" style="background:#1d547e;">
				<div class="card-body">
					<h5 class="card-title text-center font-weight-bold">Laura McDonald<br /> Photography and Videography</h5>
					<p class="card-text small"></p>
				</div>
			</div>
		</div>
		<div class="card-deck mt-3 pb-3">
			<div class="card">
				<img src="" class="card-img-top p-3 about--img rounded" alt="Glen King" style="background:#1d547e;">
				<div class="card-body">
					<h5 class="card-title text-center font-weight-bold">Glen King<br />Builder of Things</h5>
					<p class="card-text small"></p>
				</div>
			</div>
			<div class="card">
				<img src="" class="card-img-top p-3 about--img rounded" alt="Laura Schofield Pierson" style="background:#1d547e;">
				<div class="card-body">
					<h5 class="card-title text-center font-weight-bold">Laura Schofield Pierson<br />Yoga Instructor</h5>
					<p class="card-text small"></p>
				</div>
			</div>
		</div>
