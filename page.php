...
<div class="page-header">
	...
	<section id="home" data-speed="3" data-type="background" style="background: url('<?php echo $backgroundImg[0]; ?>') 80% 0 fixed;background-repeat: no-repeat;background-size:cover;"></section>
	<div class="container">
